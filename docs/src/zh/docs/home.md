基于太阳动力学观测台(SDO)上的日震和磁成像仪([HMI](http://hmi.stanford.edu))观测到的矢量磁场数据，我们利用非线性无力日冕磁场([NLFFF](https://doi.org/10.1007/s11207-012-9966-z))外推法建立了一个[三维太阳活动区磁场数据集](https://www.nature.com/articles/s41597-023-02091-5)。
