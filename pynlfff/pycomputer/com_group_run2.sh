...
PY_RUN="/home/ma-user/work/build-nlfff/app_python/com_group_run2.py"             # 主运行脚本文件，需要提前下载好环境
...
SAVE_PATH="/home/ma-user/work/pro/archive-202209/grid2.done"                  # 保存预处理产品的目录，里面有todo1.txt num_0700_0799/hmixxx 等
